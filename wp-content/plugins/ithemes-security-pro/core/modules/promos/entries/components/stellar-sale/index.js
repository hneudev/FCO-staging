...
export default function StellarSale( { installType } ) {
	...
	const subtitle = installType === 'free'
		? __( 'Save 30% on Solid Security Pro.', 'it-l10n-ithemes-security-pro' )
		: __( 'Save 30% on Solid Suite.', 'it-l10n-ithemes-security-pro' );
			...
			<StyledStellarSale>
				<StyledStellarSaleContent isSmall={ isSmall }>
					<StyledStellarSaleHeading
						...
						isSmall={ isSmall }
					>
						<strong>{ __( 'Hackers Hate This Sale', 'it-l10n-ithemes-security-pro' ) }</strong>
						<br />
						{ subtitle }
					</StyledStellarSaleHeading>
					{ isSmall && (
						<Text
							...
							text={ createInterpolateElement(
								__( 'Save <b>30%</b> on StellarWP brands like StellarSites, Kadence, GiveWP, and more during the Stellar Sale now through August 5th.', 'it-l10n-ithemes-security-pro' ),
								{
									b: <strong />,
								}
							) }
